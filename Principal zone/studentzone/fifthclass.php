...
if (isset($_POST['firstclassbtn'])) {
    $query = "INSERT INTO `fifthclass`(`rollno`, `studentname`, `fname`, `mname`, `gender`, `dob`, `section`, `address`, `remark`) VALUES ('$_POST[rollno]','$_POST[studentname]','$_POST[fname]','$_POST[mname]','$_POST[gender]','$_POST[dob]','$_POST[section]','$_POST[address]','$_POST[remark]')";
